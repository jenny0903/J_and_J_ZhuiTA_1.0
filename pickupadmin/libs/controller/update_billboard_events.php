...
$id_rule_female = $_POST['id_rule1'];
$id_rule_male = $_POST['id_rule2'];
$id_rule_money = $_POST['id_rule3'];
...
$url_events = $pickup->getApiUrl()."/billboard/events?id=$id";
$temp_events = $pickup->pickupLinkApi($url_events,"post",$data_events,1,0);
$temp_awards_female = 0;
$temp_awards_male = 0;
$temp_awards_money = 0;

$url_awards_female = $pickup->getApiUrl()."/billboard/rule?id=".$id_rule_female;
$data_awards_female = array (
	"level1" => $name_awards_female1,
	"level2" => $name_awards_female2,
	"level3" => $name_awards_female3
); 
$temp_awards_female = $pickup->pickupLinkApi($url_awards_female,"post",$data_awards_female,1,0);
$url_awards_male = $pickup->getApiUrl()."/billboard/rule?id=".$id_rule_male;
$data_awards_male = array (
	"level1" => $name_awards_male1,
	"level2" => $name_awards_male2,
	"level3" => $name_awards_male3
);
$temp_awards_male = $pickup->pickupLinkApi($url_awards_male,"post",$data_awards_male,1,0);
$url_awards_money = $pickup->getApiUrl()."/billboard/rule?id=".$id_rule_money;
$data_awards_money = array (
	"level1" => $name_awards_money1,
	"level2" => $name_awards_money2,
	"level3" => $name_awards_money3
);
$temp_awards_money = $pickup->pickupLinkApi($url_awards_money,"post",$data_awards_money,1,0);	
